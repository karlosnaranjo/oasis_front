            ...
            <Formik enableReinitialize initialValues={state} validationSchema={validationSchema} onSubmit={submit}>
                ...
                <Form>
                    ...
                    <Grid container direction="row" spacing={2}>
                        ...
                        <Grid item xs={6} md={6} xl={6}>
                            <Field label="Antecedentes familiares" name="family_history" component={TextBase} 
                                //onClick={(event) => handleChangefamily_history(event)} 
                            />
                        </Grid>
            
                        <Grid item xs={6} md={6} xl={6}>
                            <Field label="Antecedentes laborales" name="work_history" component={TextBase} 
                                //onClick={(event) => handleChangework_history(event)} 
                            />
                        </Grid>
            
                        <Grid item xs={6} md={6} xl={6}>
                            <Field label="Historia personal" name="personal_history" component={TextBase} 
                                //onClick={(event) => handleChangepersonal_history(event)} 
                            />
                        </Grid>
            
                        <Grid item xs={6} md={6} xl={6}>
                            <Field label="Historia de adiccion" name="addiction_history" component={TextBase} 
                                //onClick={(event) => handleChangeaddiction_history(event)} 
                            />
                        </Grid>
            
                        <Grid item xs={6} md={6} xl={6}>
                            <Field label="Via de administracion" name="way_administration" component={TextBase} 
                                //onClick={(event) => handleChangeway_administration(event)} 
                            />
                        </Grid>
            
                        <Grid item xs={6} md={6} xl={6}>
                            <Field label="Otras subtancias" name="other_substances" component={TextBase} 
                                //onClick={(event) => handleChangeother_substances(event)} 
                            />
                        </Grid>
            
                        <Grid item xs={6} md={6} xl={6}>
                            <Field label="Mayor sustancia" name="highest_substance" component={TextBase} 
                        ...
                        <Grid item xs={6} md={6} xl={6}>
                            <Field label="Lugares y tiempos de tratamiento" name="place_treatment" component={TextBase} 
                                //onClick={(event) => handleChangeplace_treatment(event)} 
                            />
                        </Grid>
            
                        <Grid item xs={6} md={6} xl={6}>
                            <Field label="Historia de enfermedad mental" name="mental_illness" component={TextBase} 
                                //onClick={(event) => handleChangemental_illness(event)} 
                            />
                        </Grid>
            
                        <Grid item xs={6} md={6} xl={6}>
                            <Field label="Ha tenido pensamientos o intentos de suicidio?" name="suicidal_thinking" component={TextBase} 
                                //onClick={(event) => handleChangesuicidal_thinking(event)} 
                            />
                        </Grid>
            
                        <Grid item xs={6} md={6} xl={6}>
                            <Field label="Ha tenido pensamientos o intentos homicidas?" name="homicidal_attempts" component={TextBase} 
                                //onClick={(event) => handleChangehomicidal_attempts(event)} 
                            />
                        </Grid>
            
                        <Grid item xs={6} md={6} xl={6}>
                            <Field label="Lenguaje y pensamiento" name="language" component={TextBase} 
                                //onClick={(event) => handleChangelanguage(event)} 
                            />
                        </Grid>
            
                        <Grid item xs={6} md={6} xl={6}>
                            <Field label="Orientacion (Persona, espacio y tiempo):" name="orientation" component={TextBase} 
                                //onClick={(event) => handleChangeorientation(event)} 
                            />
                        </Grid>
            
                        <Grid item xs={6} md={6} xl={6}>
                            <Field label="Memoria" name="memory" component={TextBase} 
                                //onClick={(event) => handleChangememory(event)} 
                            />
                        </Grid>
            
                        <Grid item xs={6} md={6} xl={6}>
                            <Field label="Estado de animo" name="mood" component={TextBase} 
                                //onClick={(event) => handleChangemood(event)} 
                            />
                        </Grid>
            
                        <Grid item xs={6} md={6} xl={6}>
                            <Field label="Alimentacion" name="feeding" component={TextBase} 
                                //onClick={(event) => handleChangefeeding(event)} 
                            />
                        </Grid>
            
                        <Grid item xs={6} md={6} xl={6}>
                            <Field label="Sueno" name="sleep" component={TextBase} 
                                //onClick={(event) => handleChangesleep(event)} 
                            />
                        </Grid>
            
                        <Grid item xs={6} md={6} xl={6}>
                            <Field label="Esta tomando algun tipo de medicamento?" name="medication" component={TextBase} 
                                //onClick={(event) => handleChangemedication(event)} 
                            />
                        </Grid>
            
                        <Grid item xs={6} md={6} xl={6}>
                            <Field label="Problematicas judiciales y/o comportamentales" name="legal_issues" component={TextBase} 
                                //onClick={(event) => handleChangelegal_issues(event)} 
                            />
                        </Grid>
            
                        <Grid item xs={6} md={6} xl={6}>
                            <Field label="Mecanismos de defensa" name="defense_mechanism" component={TextBase} 
                                //onClick={(event) => handleChangedefense_mechanism(event)} 
                            />
                        </Grid>
            
                        <Grid item xs={6} md={6} xl={6}>
                            <Field label="Otras dificultades" name="another_difficulty" component={TextBase} 
                                //onClick={(event) => handleChangeanother_difficulty(event)} 
                            />
                        </Grid>
            
                        <Grid item xs={6} md={6} xl={6}>
                            <Field label="Que expectativas y motivaciones tiene para el proceso?" name="expectation" component={TextBase} 
                                //onClick={(event) => handleChangeexpectation(event)} 
                            />
                        </Grid>
            
                        <Grid item xs={6} md={6} xl={6}>
                            <Field label="Impresion diagnostica" name="diagnostic_impression" component={TextBase} 
                                //onClick={(event) => handleChangediagnostic_impression(event)} 
                            />
                        </Grid>
            
                        <Grid item xs={6} md={6} xl={6}>
                            <Field label="Propuesta de intervencion" name="intervention" component={TextBase} 
